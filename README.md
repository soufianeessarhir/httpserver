...
- [Nginx Event-Driven Architecture](https://www.aosabook.org/en/nginx.html)
- [Nginx Beginner's Guide](https://nginx.org/en/docs/beginners_guide.html)
- [Core Functionality](https://nginx.org/en/docs/ngx_core_module.html)
- [Server Blocks Examples](https://nginx.org/en/docs/http/server_names.html)
...
- [Nginx Error Pages](https://nginx.org/en/docs/http/ngx_http_core_module.html#error_page)
